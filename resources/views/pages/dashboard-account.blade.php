                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            >
                                                <option value="{{ $user->provinces_id }}" selected> Provinsi Sekarang ({{ $user->province->name }})</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            >
                                                <option value="{{ $user->regencies_id }}" selected> Kota/Kabupaten Sekarang ({{ $user->regency->name }})</option>
