...
return [
    ...
    */
    ...
    'gt' => [
        'numeric' => 'Isian :attribute seharusnya lebih besar dari :max.',
        ...
        'array' => 'Isian :attribute seharusnya lebih besar dari :max item.',
    ],
    'gte' => [
        'numeric' => 'Isian :attribute seharusnya lebih besar dari atau sama dengan :max.',
        'file' => 'Isian :attribute seharusnya lebih besar dari atau sama dengan :max kilobytes.',
        'string' => 'Isian :attribute seharusnya lebih besar dari atau sama dengan :max karakter.',
        'array' => 'Isian :attribute seharusnya lebih besar dari atau sama dengan :max item.',
    ],
    ...
    'lt' => [
        'numeric' => 'Isian :attribute seharusnya lebih kecil dari :max.',
        'file' => 'Isian :attribute seharusnya lebih kecil dari :max kilobytes.',
        'string' => 'Isian :attribute seharusnya lebih kecil dari :max karakter.',
        'array' => 'Isian :attribute seharusnya lebih kecil dari :max item.',
    ],
    'lte' => [
        'numeric' => 'Isian :attribute seharusnya lebih kecil dari atau sama dengan :max.',
        'file' => 'Isian :attribute seharusnya lebih kecil dari atau sama dengan :max kilobytes.',
        'string' => 'Isian :attribute seharusnya lebih kecil dari atau sama dengan :max karakter.',
        'array' => 'Isian :attribute seharusnya lebih kecil dari atau sama dengan :max item.',
    ],
    'max' => [
    ...
    'starts_with' => 'Isian :attribute harus diawali dengan beberapa kata berikut: :values.',
